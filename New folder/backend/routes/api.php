...
use App\Http\Controllers\MembershipDirectIncomeController;
use App\Http\Controllers\MlmPlanController;
use App\Http\Controllers\MlmPlanLabelController;
...
Route::apiResource('MlmPlans', MlmPlanController::class);
Route::apiResource('MlmPlanLabels', MlmPlanLabelController::class);
Route::apiResource('MembershipDirectIncome', MembershipDirectIncomeController::class);
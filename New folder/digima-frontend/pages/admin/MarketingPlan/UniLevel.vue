...
<template>
  <div class="bg-white min-w-full h-full p-6 rounded-md shadow-md">
    <div class="flex justify-between items-center">
      <h3 class="text-2xl font-semibold text-gray-800">Unilevel Distribute Slot List</h3>

      <div class="flex items-center space-x-4">
        <SecondaryButton @click="showModalPlaceSlot = true">
          <p class="text-xs font-medium">Ready Distribution</p>
        </SecondaryButton>
      </div>
    </div>
      ...
      >
        <thead class="bg-slate-100 text-gray-700">
          <tr>
            ...
            <th class="px-4 py-2 border-b border-slate-100">PPV</th>
            <th class="px-4 py-2 border-b border-slate-100">Sponsor</th>

...
definePageMeta({
  ...
  path: "/personalcashbackdistribution",
});
...
<template>
  <div class="bg-white min-w-full h-full p-6 rounded-md shadow-md">
    <div class="flex justify-between items-center">
      <h3 class="text-2xl font-semibold text-gray-800">Personal Cashback Distribution</h3>
      ...
      >
        <thead class="bg-slate-100 text-gray-700">
          <tr>
            ...
            <th class="px-4 py-2 border-b border-slate-100">Cashback Points</th>

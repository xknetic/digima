...
definePageMeta({
  ...
  path: "/claimedrewarditem",
  name: "Reward Item Lists"
});
      ...
      >
        <thead class="bg-slate-100 text-gray-700">
          <tr>
            ...
            <th class="px-4 py-2 border-b border-slate-100">Contact Number</th>
            <th class="px-4 py-2 border-b border-slate-100">Item Name</th>
            <th class="px-4 py-2 border-b border-slate-100">Price</th>
            <th class="px-4 py-2 border-b border-slate-100">Claimed At</th>
